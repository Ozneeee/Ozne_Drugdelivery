...
Config.nameJob                    = "unemployed"
Config.nameJobLabel               = "GoFast"
Config.platePrefix                = "GoFast"
Config.Locale                     = 'fr'
...
Config.Zones = {
  ...
  Cloakroom = {
    Pos     = {x = 152.36, y = -1000.85, z = -99.001},
	...
	hint = 'Appuyez sur ~INPUT_CONTEXT~ pour récuperer la drogue',
  },

  VehicleSpawner = {
	Pos   = {x = 455.23, y = -1575.93, z = 31.9},
	Size  = {x = 1.5, y = 1.5, z = 0.6},
	Color = {r = 220, g = 0, b = 0},
	Type  = 27,
	BlipSprite = 303,
	...
	hint = 'Appuyez sur ~INPUT_CONTEXT~ sortir votre véhicule',
  },

  VehicleSpawnPoint = {
	Pos   = {x = 470.75, y = -1577.45, z = 29.1},
  ...
  VehicleDeleter = {
	Pos   = {x = 476.96, y = -1568.9, z = -129.12},
  ...
  Vente = {
	...
	ItemName = "Sachet de Drogues",
	ItemMax = 100,
	ItemAdd = 1,
	ItemRemove = 1,
	ItemRequires = "sacbillets",
	ItemRequires_name = "Sachet de Drogues",
	ItemDrop = 100,
	ItemPrice  = 100,
	hint = 'Appuyez sur ~INPUT_CONTEXT~ pour vendre la drogue',
  },
...
Config.DAB = {
  ...
  { ['x'] = -583.26	,	    ['y'] = 	227.22	    ,	['z'] =     78.7	}, -- parking white
{ ['x'] = 	-1360.7	,   	['y'] = 	-757.86	    ,	['z'] = 	22.2	}, -- garage bgs
{ ['x'] = 	-1108.01	,	['y'] = 	-1642.65	,	['z'] = 	4.64	}, -- local alpenos 
{ ['x'] = 	-1487.01	,	['y'] = 	-909.701	,	['z'] = 	10.02	}, -- dealer lb
{ ['x'] = 	1193.11	    ,	['y'] = 	61655.8  	,	['z'] = 	43.03	}, -- maison marabunta
{ ['x'] = 	343.92  	,	['y'] = 	-999.78 	,	['z'] = 	29.33	}, -- porte mission row
{ ['x'] = 	474.14	    ,	['y'] = 	-634.52 	,	['z'] = 	25.65	}, -- train missiow row
{ ['x'] = 	957.74  	,	['y'] = 	-214.12 	,	['z'] = 	76.2	}, -- boxclub
{ ['x'] = 	338.71	    ,	['y'] = 	-219.26 	,	['z'] = 	58.02	}, --motel alta
{ ['x'] = 	551.92	    ,	['y'] = 	2663.43 	,	['z'] = 	45.87	}, -- superette route 68
{ ['x'] = 	382.16  	,	['y'] = 	2576.12 	,	['z'] = 	44.05	}, -- trailer park route 68
{ ['x'] = 	903.72  	,	['y'] = 	3560.61 	,	['z'] = 	33.81	}, -- casse sandy shores
